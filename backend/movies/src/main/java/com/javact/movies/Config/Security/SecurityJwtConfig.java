...
import com.javact.movies.services.JwtService;
...
public class SecurityJwtConfig extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        final String authHedear = request.getHeader("Authorization");
        final String jwt;
        ...
        if (usernameOrEmail != null && SecurityContextHolder.getContext().getAuthentication() == null){
            ...
            if (jwtService.isTokenValid(jwt, userDetails)){
                ...
                SecurityContextHolder.getContext().setAuthentication(authToken); //100% dobre
            }
        }
        filterChain.doFilter(request,response);
    }
