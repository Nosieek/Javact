...
//   //   }
//   // }; stare
//   // Funkcja do dodawania/usuwania filmu z ulubionych
...
//       // Jeśli film jest już w ulubionych, usuń go
//       const response = await axios.post(
//         `movies/Fav/delete?email=${userEmail}&movieId=${movieId}`,
//         {},
//         {
//           headers: {
//             Authorization: `Bearer ${tk}`
...
//       // Usuń film z listy ulubionych w stanie komponentu
//       setFavorites((prevFavorites) => prevFavorites.filter((favorite) => favorite.id !== movieId));
//     } else {
//       // Jeśli film nie jest jeszcze w ulubionych, dodaj go
//       const response = await axios.post(
//         `movies/addFav?email=${userEmail}&movieId=${movieId}`,
//         {},
//         {
...
//       // Dodaj film do listy ulubionych w stanie komponentu
...
const TopRanked = () => {
  ...
  const isMovieInFavorites = (movieId) => {
    // console.log(favorites.some((favorite) => favorite.getMovieDetail))
    // console.log(favorites.some((favorite) => favorite.imdb));
  ...
  const toggleFavorite = async (movieId) => {
    try {
      ...
      // Po zaktualizowaniu ulubionych filmów wykonaj ponowne zapytanie do serwera,
      // aby uzyskać aktualną listę ulubionych użytkownika
      fetchFavorites();
    } catch (error) {
      console.error('Error toggling favorite:', error);
    }
