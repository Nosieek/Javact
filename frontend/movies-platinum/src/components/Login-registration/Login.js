...
//   const [autoLogout, setAutoLogout] = useState(false); // Dodajemy autoLogout

//   useEffect(() => {
//     if (autoLogout) { // Check if autoLogout is true
...
const Login = () => {
  ...
  useEffect(() => {
    if (logout === 'true') { // Check if logout is true
      setAutoLogout(true); // Set autoLogout to true
    }
  }, [logout]);
